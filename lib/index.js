...
exports.getDocsPluginConfig = exports.isURL = exports.sampleResponseFromSchema = exports.createRequestSchema = exports.createDescription = exports.lessThan = exports.greaterThan = exports.renderChildren = exports.create = void 0;
...
Object.defineProperty(exports, "sampleResponseFromSchema", { enumerable: true, get: function () { return openapi_2.sampleResponseFromSchema; } });
function isURL(str) {
    ...
    async function generateApiDocs(options, pluginId) {
        ...
        try {
            ...
            if (Object.keys(sidebarOptions !== null && sidebarOptions !== void 0 ? sidebarOptions : {}).length > 0) {
                ...
                const nonApiMdxFiles = await (0, utils_1.Globby)(["*.mdx"], {
